...
public class TSConstantsProduction: TSConstantsProtocol {
    ...
    public let textSecureCDN0ServerURL = "https://x-server.ngrok.app"
    public let textSecureCDN2ServerURL = "https://x-server.ngrok.app"
    public let textSecureCDN3ServerURL = "https://x-server.ngrok.app"
    ...
    public let svr2URL = "wss://x-server.ngrok.app"
    public let registrationCaptchaURL = "https://x-server.ngrok.app/registration/generate.html"
    public let challengeCaptchaURL = "https://x-server.ngrok.app/challenge/generate.html"
    public let kUDTrustRoot = "BegSkx6Q4QEHbNQjm4b2bbTFrAKWz7MF4Bvp4ongBrFw"
    public let updatesURL = "https://x-server.ngrok.app"
    public let updates2URL = "https://x-server.ngrok.app"
...
public class TSConstantsStaging: TSConstantsProtocol {
    ...
    public let storageServiceURL = "https://x-storage.ngrok.app"
    public let sfuURL = "https://x-server.ngrok.app"
    public let svr2URL = "wss://459c6bf513bb.ngrok-free.app"
    public let registrationCaptchaURL = "https://x-server.ngrok.app/registration/generate.html"
    public let challengeCaptchaURL = "https://x-server.ngrok.app/challenge/generate.html"
    // There's no separate test SFU for staging.
    public let sfuTestURL = "https://x-server.ngrok.app"
    public let kUDTrustRoot = "CpG5pS1EDf61iptf2/usGWwfo2nICR6A4khdoicT2ic="
